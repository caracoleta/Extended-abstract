...
%% Enhanced table packages
\usepackage{array}      % Enhanced array and tabular environments
\usepackage{tabularx}   % Flexible width tables
\usepackage{booktabs}   % Professional quality tables with \toprule, \midrule, \bottomrule
\usepackage{longtable}  % Tables that can span multiple pages
\usepackage{multirow}   % Multi-row cells in tables
\usepackage{multicol}   % Multiple columns with \begin{multicols}{n}
\usepackage{caption}    % Enhanced captions and \captionof command
...
\date{December 2025}
\author{Gonçalo Valente Monteiro da Silva \\ goncalovalentesilva@tecnico.ulisboa.pt \\ \\ Instituto Superior T\'{e}cnico, Universidade de Lisboa, Portugal}
...
% Reduce font size and spacing for bibliography
{\footnotesize
